...
* [base-pipeline](https://www.npmjs.com/package/base-pipeline): base-methods plugin that adds pipeline and plugin methods for easily and programmatically composing streaming plugin… [more](https://www.npmjs.com/package/base-pipeline) | [homepage](https://github.com/jonschlinkert/base-pipeline)
